    ...
    <div class="row">
        <div class="col-12 col-lg-6 col-md-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <h3 class="mb-2 text-gray-700">Tambah Data Produk</h3>
                    <form action="<?= site_url("/products") ?>" method="post" id="form-create">
                        <div class="mb-2">
                            <label for="name" class="col-form-label text-gray-700 fw-500">Nama Produk <span class="text-danger">*</span></label>
                            <input type="text" name="name" id="name" required value="<?= old("name") ?>" class="form-control solid fw-500 text-gray-700">
                        </div>
                        <div class="mb-2">
                            <label for="code" class="col-form-label text-gray-700 fw-500">Kode Produk</label>
                            <input type="number" name="code" id="code" value="<?= old("code") ?>" class="form-control solid fw-500 text-gray-700">
                        </div>
                        <div class="mb-2">
                        ...
                        <div class="mb-2 row" id="lens-type-regular-wrapper" hidden>
                            <div class="col">
                                ...
                                <input type="text" name="sph" id="sph" class="form-control solid fw-500 text-gray-700">
                            </div>
                            <div class="col">
                                <label for="cyl" class="col-form-label text-gray-700 fw-500">CYL</label>
                                <input type="text" name="cyl" id="cyl" class="form-control solid fw-500 text-gray-700">
                            </div>
                            <div class="col">
                                <label for="add" class="col-form-label text-gray-700 fw-500">ADD</label>
                                <input type="text" name="add" id="add" class="form-control solid fw-500 text-gray-700">
                            </div>
                        </div>
                        <div class="mb-2 row" id="lens-type-progressive-wrapper" hidden>
                            <div class="input-group mb-2">
                                ...
                                <input type="text" name="r_sph" id="r-sph" placeholder="SPH" value="<?= old("r_sph") ?>" class="form-control solid text-gray-700 me-2 fw-500">
                                <input type="text" name="r_cyl" id="r-cyl" placeholder="CYL" value="<?= old("r_cyl") ?>" class="form-control solid text-gray-700 me-2 fw-500">
                                <input type="text" name="r_add" id="r-add" placeholder="ADD" value="<?= old("r_add") ?>" class="form-control solid text-gray-700 fw-500">
                            </div>
                            <div class="input-group mb-2">
                                <span class="input-group-text border-0 bg-primary text-white rounded-2 fw-600 me-2">L</span>
                                <input type="text" name="l_sph" id="l-sph" placeholder="SPH" value="<?= old("l_sph") ?>" class="form-control solid text-gray-700 me-2 fw-500">
                                <input type="text" name="l_cyl" id="l-cyl" placeholder="CYL" value="<?= old("l_cyl") ?>" class="form-control solid text-gray-700 me-2 fw-500">
                                <input type="text" name="l_add" id="l-add" placeholder="ADD" value="<?= old("l_add") ?>" class="form-control solid text-gray-700 fw-500">
                            </div>
                        </div>
                        <div class="mb-2">
                            <label for="minimum-qty" class="col-form-label text-gray-700 fw-500">Minimum Qty</label>
                            <input type="number" name="minimum_qty" value="<?= old("qty") ?>" id="minimum-qty" class="form-control solid fw-500 text-gray-700">
                        </div>
                        <div class="mb-2">
                            <label for="qty" class="col-form-label text-gray-700 fw-500">Qty</label>
                            <input type="number" name="qty" value="<?= old("qty") ?>" id="qty" class="form-control solid fw-500 text-gray-700">
                        </div>
                        <div class="mb-2">
                            <label for="original-price" class="col-form-label text-gray-700 fw-500">Harga Asli <span class="text-danger">*</span></label>
                            <input type="text" name="original_price" value="<?= old("original_price") ?>" id="original-price" required class="form-control solid fw-500 text-gray-700 format-rupiah-input">
                        </div>
                        <div class="mb-2">
                            <label for="selling-price" class="col-form-label text-gray-700 fw-500">Harga Jual <span class="text-danger">*</span></label>
                            <input type="text" name="selling_price" value="<?= old("selling_price") ?>" id="selling-price" required class="form-control solid fw-500 text-gray-700 format-rupiah-input">
                        </div>
                        <div class="mb-2">
                            <label for="member-price" class="col-form-label text-gray-700 fw-500">Harga Member <span class="text-danger">*</span></label>
                            <input type="text" name="member_price" value="<?= old("member_price") ?>" id="member-price" required class="form-control solid fw-500 text-gray-700 format-rupiah-input">
                        </div>
                        <div class="mb-4">
                            <label for="wholesale-price" class="col-form-label text-gray-700 fw-500">Harga Grosir <span class="text-danger">*</span></label>
                            <input type="text" name="wholesale_price" value="<?= old("wholesale_price") ?>" id="wholesale-price" required class="form-control solid fw-500 text-gray-700 format-rupiah-input">
                        </div>
